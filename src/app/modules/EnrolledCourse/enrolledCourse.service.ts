...
import { OfferedCourse } from '../offeredCourse/offeredCourse.model.js';
import { SemesterRegistration } from '../semesterRegistration/semesterRegistration.model.js';
import { StudentModel } from '../student/student.model.js';
import { TEnrolledCourse } from './enrolledCourse.interface.js';
import EnrolledCourse from './enrolledCourse.model.js';
import { calculateGradeAndPoints } from './enrolledCourse.utils.js';
...
const updateEnrolledCourseMarksIntoDB = async (
  ...
  if (courseMarks?.finalTerm) {
    ...
    const totalMarks = Math.round(
      classTest1 + midTerm + classTest2 + finalTerm
    );
